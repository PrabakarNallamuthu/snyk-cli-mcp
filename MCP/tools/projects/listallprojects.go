...
func ListallprojectsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/org/%s/projects", cfg.BaseURL, orgId)
...
func CreateListallprojectsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_org_orgId_projects",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListallprojectsHandler(cfg),
	}
}
