...
func ReplaceignoresHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceignoresTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_org_orgId_project_projectId_ignore_issueId",
		mcp.WithDescription("Replace ignores"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplaceignoresHandler(cfg),
	}
}
