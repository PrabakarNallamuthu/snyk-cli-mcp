...
func GetprojectdependencygraphHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/org/%s/project/%s/dep-graph", cfg.BaseURL, orgId, projectId)
...
func CreateGetprojectdependencygraphTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_org_orgId_project_projectId_dep-graph",
		mcp.WithDescription("Get Project dependency graph"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetprojectdependencygraphHandler(cfg),
	}
}
