...
func DeleteprojectsettingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteprojectsettingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_org_orgId_project_projectId_settings",
		mcp.WithDescription("Delete project settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteprojectsettingsHandler(cfg),
	}
}
