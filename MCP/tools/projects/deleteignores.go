...
func DeleteignoresHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteignoresTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_org_orgId_project_projectId_ignore_issueId",
		mcp.WithDescription("Delete ignores"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteignoresHandler(cfg),
	}
}
