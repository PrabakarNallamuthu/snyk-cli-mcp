...
func RetrieveasingleprojectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRetrieveasingleprojectTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_org_orgId_project_projectId",
		mcp.WithDescription("Retrieve a single project"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RetrieveasingleprojectHandler(cfg),
	}
}
