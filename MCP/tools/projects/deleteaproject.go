...
func DeleteaprojectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteaprojectTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_org_orgId_project_projectId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteaprojectHandler(cfg),
	}
}
