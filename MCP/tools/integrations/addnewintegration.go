...
func AddnewintegrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/org/%s/integrations", cfg.BaseURL, orgId)
...
func CreateAddnewintegrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_org_orgId_integrations",
		mcp.WithDescription("Add new integration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AddnewintegrationHandler(cfg),
	}
}
