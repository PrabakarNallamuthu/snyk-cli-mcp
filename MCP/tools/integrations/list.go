...
func CreateListTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_org_orgId_integrations",
		mcp.WithDescription("List"),
		mcp.WithString("orgId", mcp.Required(), mcp.Description("The organization public ID. The `API_KEY` must have admin access to this organization.")),
	)
