...
func UpdateexistingintegrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/org/%s/integrations/%s", cfg.BaseURL, orgId, integrationId)
...
func CreateUpdateexistingintegrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_org_orgId_integrations_integrationId",
		mcp.WithDescription("Update existing integration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateexistingintegrationHandler(cfg),
	}
}
