...
func GetlistoflatestissuesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/reporting/issues/latest%s", cfg.BaseURL, queryString)
...
func CreateGetlistoflatestissuesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_reporting_issues_latest",
		mcp.WithDescription("Get list of latest issues"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetlistoflatestissuesHandler(cfg),
	}
}
