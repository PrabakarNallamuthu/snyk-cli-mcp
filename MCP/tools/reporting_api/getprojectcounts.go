...
func GetprojectcountsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/reporting/counts/projects%s", cfg.BaseURL, queryString)
...
func CreateGetprojectcountsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_reporting_counts_projects",
		mcp.WithDescription("Get project counts"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetprojectcountsHandler(cfg),
	}
}
