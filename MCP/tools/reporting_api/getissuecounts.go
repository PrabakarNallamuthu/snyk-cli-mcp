...
func GetissuecountsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/reporting/counts/issues%s", cfg.BaseURL, queryString)
...
func CreateGetissuecountsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_reporting_counts_issues",
		mcp.WithDescription("Get issue counts"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetissuecountsHandler(cfg),
	}
}
