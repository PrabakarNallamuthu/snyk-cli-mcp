...
func ModifyprojectnotificationsettingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateModifyprojectnotificationsettingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_user_me_notification-settings_org_orgId_project_projectId",
		mcp.WithDescription("Modify project notification settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifyprojectnotificationsettingsHandler(cfg),
	}
}
